...
const { createBookingSchema, bookingIdSchema, bookingDecisionSchema, paymentIntentSchema, confirmPaymentSchema } = require("../validations/booking.validation");
...
router.get("/owner", requireAuth, requireRole("owner"), controller.ownerBookings);
...
router.get("/admin/all", requireAuth, requireRole("admin"), controller.adminBookings);
